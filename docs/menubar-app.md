...
For macOS users who prefer a native experience, there's a companion menu bar app that provides quick access to server controls without touching the terminal. Get it from: [model-hub-proxy-bar](https://github.com/IrvanFza/model-hub-proxy-bar)
...
- **Server Control**: Start/stop the proxy server with a single click or âŒ˜S shortcut.
