...
EXAMPLES:
  ...
  PORT=3000 model-hub-proxy start
  model-hub-proxy accounts add
...
async function main() {
  ...
  switch (command) {
    ...
    default:
      ...
      console.error('Run "modelhub-proxy --help" for usage information.');
      process.exit(1);
  }
}
