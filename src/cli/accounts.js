...
/**
 * Check if the Model Hub proxy server is running
...
async function ensureServerStopped() {
    ...
    if (isRunning) {
        console.error(`
\x1b[31mError: Model Hub proxy server is currently running on port ${SERVER_PORT}.\x1b[0m
...
async function main() {
    ...
    console.log('â•‘   Model Hub Account Manager    â•‘');
