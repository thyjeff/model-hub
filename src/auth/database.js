...
import { MODEL_HUB_DB_PATH } from '../constants.js';
 ...
 */
export function getAuthStatus(dbPath = MODEL_HUB_DB_PATH) {
 ...
 */
export function isDatabaseAccessible(dbPath = MODEL_HUB_DB_PATH) {
    let db;
    try {
        const Db = loadDatabaseModule();
        db = new Db(dbPath, {
