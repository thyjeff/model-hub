...
document.addEventListener('alpine:init', () => {
    Alpine.store('settings', {
        ...
        loadSettings() {
            const saved = localStorage.getItem('modelhub_settings') || localStorage.getItem('antigravity_settings');
            if (saved) {
        ...
        saveSettings(silent = false) {
            ...
            localStorage.setItem('modelhub_settings', JSON.stringify(toSave));
