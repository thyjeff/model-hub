/**
 * Global Store for Model Hub Console
...
document.addEventListener('alpine:init', () => {
    Alpine.store('global', {
        init() {
            ...
            const validSettingsTabs = ['claude', 'codex'];
            ...
            window.addEventListener('hashchange', () => {
                ...
                if (validTabs.includes(tab)) {
                    ...
                    if (tab === 'settings') {
                        this.settingsTab = validSettingsTabs.includes(subtab) ? subtab : 'claude';
                    }
                }
            });
        ...
        activeTab: 'dashboard',
        settingsTab: 'claude',
        webuiPassword: localStorage.getItem('modelhub_webui_password') || localStorage.getItem('antigravity_webui_password') || '',
