...
window.translations.en = {
    ...
    accountManagement: "Ollama Proxy Management",
    manageTokens: "Manage Ollama proxy routing and upstream health",
    addAccount: "Add Account",
    manageOllamaUpstreams: "Manage Ollama Upstreams",
    noOllamaUsageYet: "No Ollama usage yet. Send at least one Ollama request.",
    status: "STATUS",
    enabled: "ENABLED",
    health: "STATUS",
    ...
    cannotDeleteDatabase: "Cannot delete: This account is from local application database (read-only)",
    connectGoogle: "Connect Account",
    ...
    opusAlias: "Model Alias 1",
    sonnetAlias: "Model Alias 2",
    haikuAlias: "Model Alias 3",
    claudeSettingsAlertPrefix: "Settings below directly modify",
    claudeSettingsAlertSuffix: "Applied to config immediately. For current running session, run /model once to switch live.",
    codexSettingsAlertSuffix: "Restart Codex Agent to apply.",
    applyToClaude: "Apply to Agent CLI",
    applyToCodex: "Apply to Codex Agent",
    // Presets
    ...
    systemDesc: "UNIFIED MODEL GATEWAY",
    connectGoogleDesc: "Connect a provider account to enable managed request routing and higher reliability through Model Hub.",
    ...
    claudeConfigSaved: "Agent config saved. In current terminal run /model to apply live now.",
    codexConfigSaved: "Codex configuration saved",
    ...
    noAccountsDesc: "Get started by adding an account via OAuth, or use the CLI command to import credentials.",
    ...
    dangerousOperation: "Warning: Dangerous Operation",
    confirmDeletePrompt: "Are you sure you want to delete account",
    deleteWarning: "Warning: This action cannot be undone. All configuration and historical records will be permanently deleted.",
    // OAuth progress
    ...
    oauthTimeout: "OAuth authorization timed out. Please try again.",
    ...
    gemini1mWarning: "Warning: Large context may reduce Gemini performance.",
