...
window.translations.id = {
    ...
    cannotDeleteDatabase: "Tidak bisa dihapus: Akun ini dari database Model Hub (read-only)",
    ...
    connectGoogleDesc: "Hubungkan akun Google Workspace untuk meningkatkan kuota API. Akun akan digunakan untuk meneruskan request Claude via Model Hub.",
    ...
    dangerousOperation: "âš ï¸ Operasi Berbahaya",
    confirmDeletePrompt: "Yakin ingin menghapus akun",
    deleteWarning: "âš ï¸ Tindakan ini tidak bisa dibatalkan. Semua pengaturan dan riwayat akan dihapus permanen.",
    ...
    oauthTimeout: "â±ï¸ Waktu otorisasi OAuth habis. Silakan coba lagi.",
    ...
    gemini1mWarning: "âš  Konteks besar dapat menurunkan performa Gemini-3.",
